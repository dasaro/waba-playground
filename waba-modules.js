...
`,
    ...
    // =====================================================
    // SEMANTICS (from WABA/semantics/)
    // =====================================================
    // Only stable and cf are verified and correct.
    // All other semantics were removed from WABA repository due to implementation flaws.
    // See: WABA/semantics/README.md
    semantics: {
        // ✅ Verified Semantics
        stable: `%% STABLE SEMANTICS (from WABA/semantics/stable.lp)
%% Inline cf.lp since #include not supported in WASM

%% conflict freeness (from cf.lp)
:- in(X), defeated(X).

%% stable: all out assumptions must be defeated
:- not defeated(X), out(X).
`,
        cf: `%% CONFLICT-FREE SEMANTICS (from WABA/semantics/cf.lp)
%% An extension is conflict-free if no assumption in the extension is defeated
...
%% Removed due to implementation flaws. See WABA/semantics/README.md`,
        naive: `%% NOT IMPLEMENTED
%% Removed due to implementation flaws. See WABA/semantics/README.md`,
        preferred: `%% NOT IMPLEMENTED
%% Removed due to implementation flaws. See WABA/semantics/README.md`,
        'semi-stable': `%% NOT IMPLEMENTED
%% Removed due to implementation flaws. See WABA/semantics/README.md`,
        staged: `%% NOT IMPLEMENTED
%% Removed due to implementation flaws. See WABA/semantics/README.md`,
        'heuristic-naive': `%% NOT IMPLEMENTED
%% Removed due to implementation flaws. See WABA/semantics/README.md`,
        'heuristic-preferred': `%% NOT IMPLEMENTED
%% Removed due to implementation flaws. See WABA/semantics/README.md`,
        'heuristic-semi-stable': `%% NOT IMPLEMENTED
%% Removed due to implementation flaws. See WABA/semantics/README.md`,
        'heuristic-staged': `%% NOT IMPLEMENTED
%% Removed due to implementation flaws. See WABA/semantics/README.md`,
        'heuristic-grounded': `%% NOT IMPLEMENTED
%% Removed due to implementation flaws. See WABA/semantics/README.md`,
        'optN-preferred': `%% NOT IMPLEMENTED
%% Removed due to implementation flaws. See WABA/semantics/README.md`,
        'optN-semi-stable': `%% NOT IMPLEMENTED
%% Removed due to implementation flaws. See WABA/semantics/README.md`,
        'optN-staged': `%% NOT IMPLEMENTED
%% Removed due to implementation flaws. See WABA/semantics/README.md`,
        'optN-ideal': `%% NOT IMPLEMENTED
%% Removed due to implementation flaws. See WABA/semantics/README.md`,
        'optN-eager': `%% NOT IMPLEMENTED
%% Removed due to implementation flaws. See WABA/semantics/README.md`,
        'optN-grounded': `%% NOT IMPLEMENTED
%% Removed due to implementation flaws. See WABA/semantics/README.md`
