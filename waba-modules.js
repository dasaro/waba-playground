...
// Last updated: 2026-01-05T10:36:45.996Z
...
%% "≥ β" mode: Attack with score W is NON-DISCARDABLE iff W >= β
%% - When β = #sup: only W = #sup attacks are non-discardable (classical ABA)
%% - When β = 0: all W != #inf attacks are non-discardable
...
%% unaffordable_attack = non-discardable (too strong to drop)
%% "≤ β" mode: Attack with cost W is NON-DISCARDABLE iff W <= β (low cost = strong)
%% - When β = 0: all W != #inf attacks are non-discardable (classical ABA)
%% - For finite β: attacks with W <= β are non-discardable (too strong/cheap)
unaffordable_attack(W,B) :- undefeated_weight(_,W), budget(B), B = 0, W != #inf.
