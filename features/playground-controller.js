import { ThemeManager } from '../modules/theme-manager.js?v=20260730-4';
import { FontManager } from '../modules/font-manager.js?v=20260730-4';
import { UIManager } from '../modules/ui-manager.js?v=20260730-4';
import { PanelManager } from '../modules/panel-manager.js?v=20260730-4';
import { FileManager } from '../modules/file-manager.js?v=20260730-4';
import { GraphManager } from '../modules/graph-manager.js?v=20260730-4';
import { PopupManager } from '../modules/popup-manager.js?v=20260730-4';
import { ClingoManager } from '../modules/clingo-manager.js?v=20260730-4';
import { OutputManager } from '../modules/output-manager.js?v=20260730-4';
import { ExportManager } from '../modules/export-manager.js?v=20260730-4';
import { MetricsManager } from '../modules/metrics-manager.js?v=20260730-4';
import { ConfigController } from './config-controller.js?v=20260730-4';
import { DocsController } from './docs-controller.js?v=20260730-4';
import { EditorController } from './editor-controller.js?v=20260730-4';
import { ExamplesController } from './examples-controller.js?v=20260730-4';
